...
public class Constant {
    ...
    public static final  Integer HOT_NUMBER = 10;//热门商品显示数量
    public static final String NOT_SEARCH_TIP = "没有找到相关商品";//商品搜索时没有找到相关商品的提示
    public static final String ADD_COLLECT = "添加成功";//添加收藏成功
